...
if ($useAJAX) {
	$includes.="var AUTOCOMPLETE_TABLE='weekly_autocomplete.php';\r\n";
	$includes.="var INLINE_EDIT_TABLE='weekly_edit.php';\r\n";
	$includes.="var INLINE_ADD_TABLE='weekly_add.php';\r\n";
	$includes.="var INLINE_VIEW_TABLE='weekly_view.php';\r\n";
	$includes.="var SUGGEST_TABLE='weekly_searchsuggest.php';\r\n";
	$includes.="var MASTER_PREVIEW_TABLE='weekly_masterpreview.php';\r\n";
	$includes.="var SUGGEST_LOOKUP_TABLE='weekly_lookupsuggest.php';";
}
$includes.="\n</script>\n";
if ($useAJAX) {
...
$smarty->assign("pagination","<script language=\"JavaScript\">WritePagination(".$mypage.",".$maxpages.");
		...
		{
			window.location='weekly_list.php?goto='+nPageNumber;
		}
</script>");
