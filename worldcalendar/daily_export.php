...
$smarty->display("daily_export.htm");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=daily.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=daily.xml");
