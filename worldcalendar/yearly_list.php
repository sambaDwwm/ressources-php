...
if ($useAJAX) {
	$includes.="var AUTOCOMPLETE_TABLE='yearly_autocomplete.php';\r\n";
	$includes.="var INLINE_EDIT_TABLE='yearly_edit.php';\r\n";
	$includes.="var INLINE_ADD_TABLE='yearly_add.php';\r\n";
	$includes.="var INLINE_VIEW_TABLE='yearly_view.php';\r\n";
	$includes.="var SUGGEST_TABLE='yearly_searchsuggest.php';\r\n";
	$includes.="var MASTER_PREVIEW_TABLE='yearly_masterpreview.php';\r\n";
	$includes.="var SUGGEST_LOOKUP_TABLE='yearly_lookupsuggest.php';";
}
$includes.="\n</script>\n";
if ($useAJAX) {
...
$smarty->assign("pagination","<script language=\"JavaScript\">WritePagination(".$mypage.",".$maxpages.");
		...
		{
			window.location='yearly_list.php?goto='+nPageNumber;
		}
</script>");
