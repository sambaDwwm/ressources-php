...
$keys=array();
$templatefile = "edit_calendar_add.htm";
...
//	insert masterkey value if exists and if not specified
	if(@$_SESSION[$strTableName."_mastertable"]=="customer")
	{
		$avalues["Description"]=prepare_for_db("Description",$_SESSION[$strTableName."_masterkey1"]);
	}
