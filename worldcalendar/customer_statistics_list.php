...
if ($useAJAX) {
	$includes.="var AUTOCOMPLETE_TABLE='customer_statistics_autocomplete.php';\r\n";
	$includes.="var INLINE_EDIT_TABLE='customer_statistics_edit.php';\r\n";
	$includes.="var INLINE_ADD_TABLE='customer_statistics_add.php';\r\n";
	$includes.="var INLINE_VIEW_TABLE='customer_statistics_view.php';\r\n";
	$includes.="var SUGGEST_TABLE='customer_statistics_searchsuggest.php';\r\n";
	$includes.="var MASTER_PREVIEW_TABLE='customer_statistics_masterpreview.php';\r\n";
	$includes.="var SUGGEST_LOOKUP_TABLE='customer_statistics_lookupsuggest.php';";
}
$includes.="\n</script>\n";
if ($useAJAX) {
...
$smarty->assign("pagination","<script language=\"JavaScript\">WritePagination(".$mypage.",".$maxpages.");
		...
		{
			window.location='customer_statistics_list.php?goto='+nPageNumber;
		}
</script>");
...
//	include proper masterlist.php code
	...
	DisplayMasterTableInfo("customer statistics", $masterkeys);
...
$templatefile = "customer_statistics_list.htm";
