...
include("include/edit_calendar_variables.php");
...
if ($useAJAX) {
	$includes.="var AUTOCOMPLETE_TABLE='edit_calendar_autocomplete.php';\r\n";
	$includes.="var INLINE_EDIT_TABLE='edit_calendar_edit.php';\r\n";
	$includes.="var INLINE_ADD_TABLE='edit_calendar_add.php';\r\n";
	$includes.="var INLINE_VIEW_TABLE='edit_calendar_view.php';\r\n";
	$includes.="var SUGGEST_TABLE='edit_calendar_searchsuggest.php';\r\n";
	$includes.="var MASTER_PREVIEW_TABLE='edit_calendar_masterpreview.php';\r\n";
	$includes.="var SUGGEST_LOOKUP_TABLE='edit_calendar_lookupsuggest.php';";
}
$includes.="\n</script>\n";
if ($useAJAX) {
...
{
	$where ="";
		$where.= GetFullFieldName("Description")."=".make_db_value("Description",$_SESSION[$strTableName."_masterkey1"]);
	$strWhereClause = whereAdd($strWhereClause,$where);
//	$strSQL = AddWhere($strSQL,$where);
}
...
$smarty->assign("pagination","<script language=\"JavaScript\">WritePagination(".$mypage.",".$maxpages.");
		...
		{
			window.location='edit_calendar_list.php?goto='+nPageNumber;
		}
</script>");
...
//	Description - 
				...
				if(strlen($data["Description"]))
			{
				...
				$LookupSQL.=" FROM `customer` WHERE `idcustomer` = " . $strdata;
							$LookupSQL.=" and ("." usercal = ". $_SESSION["OwnerID"].")"; 
				LogInfo($LookupSQL);
...
$strPerm = GetUserPermissions("edit calendar");
$smarty->assign("allow_edit_calendar",!(strpos($strPerm, "A")===false && strpos($strPerm, "S")===false));
...
//	include proper masterlist.php code
	include("include/customer_masterlist.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	DisplayMasterTableInfo("edit calendar", $masterkeys);
	$smarty->assign("showmasterfile","customer_masterlist.htm");
}
...
$templatefile = "edit_calendar_list.htm";
