...
if ($useAJAX) {
	$includes.="var AUTOCOMPLETE_TABLE='daily_autocomplete.php';\r\n";
	$includes.="var INLINE_EDIT_TABLE='daily_edit.php';\r\n";
	$includes.="var INLINE_ADD_TABLE='daily_add.php';\r\n";
	$includes.="var INLINE_VIEW_TABLE='daily_view.php';\r\n";
	$includes.="var SUGGEST_TABLE='daily_searchsuggest.php';\r\n";
	$includes.="var MASTER_PREVIEW_TABLE='daily_masterpreview.php';\r\n";
	$includes.="var SUGGEST_LOOKUP_TABLE='daily_lookupsuggest.php';";
}
$includes.="\n</script>\n";
if ($useAJAX) {
...
$smarty->assign("pagination","<script language=\"JavaScript\">WritePagination(".$mypage.",".$maxpages.");
		...
		{
			window.location='daily_list.php?goto='+nPageNumber;
		}
</script>");
