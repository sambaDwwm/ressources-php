...
if ($useAJAX) {
	...
	$includes.="var INLINE_EDIT_TABLE='calendar_edit.php';\r\n";
	$includes.="var INLINE_ADD_TABLE='calendar_add.php';\r\n";
	$includes.="var INLINE_VIEW_TABLE='calendar_view.php';\r\n";
	$includes.="var SUGGEST_TABLE='calendar_searchsuggest.php';\r\n";
	$includes.="var MASTER_PREVIEW_TABLE='calendar_masterpreview.php';\r\n";
...
$smarty->assign("pagination","<script language=\"JavaScript\">WritePagination(".$mypage.",".$maxpages.");
		...
		{
			window.location='calendar_list.php?goto='+nPageNumber;
		}
</script>");
...
$templatefile = "calendar_list.htm";
