...
include("include/Copy_of_calendar_variables.php");
...
if ($useAJAX) {
	$includes.="var AUTOCOMPLETE_TABLE='Copy_of_calendar_autocomplete.php';\r\n";
	$includes.="var INLINE_EDIT_TABLE='Copy_of_calendar_edit.php';\r\n";
	$includes.="var INLINE_ADD_TABLE='Copy_of_calendar_add.php';\r\n";
	$includes.="var INLINE_VIEW_TABLE='Copy_of_calendar_view.php';\r\n";
	$includes.="var SUGGEST_TABLE='Copy_of_calendar_searchsuggest.php';\r\n";
	$includes.="var MASTER_PREVIEW_TABLE='Copy_of_calendar_masterpreview.php';\r\n";
	$includes.="var SUGGEST_LOOKUP_TABLE='Copy_of_calendar_lookupsuggest.php';";
}
$includes.="\n</script>\n";
if ($useAJAX) {
...
$smarty->assign("pagination","<script language=\"JavaScript\">WritePagination(".$mypage.",".$maxpages.");
		...
		{
			window.location='Copy_of_calendar_list.php?goto='+nPageNumber;
		}
</script>");
...
$templatefile = "Copy_of_calendar_list.htm";
