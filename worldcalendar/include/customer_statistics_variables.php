...
$strTableName="customer statistics";
...
$gstrOrderBy="ORDER BY `Description` ASC, `DateField` ASC, `TimeField` ASC";
...
include("include/customer_statistics_settings.php");
include("include/customer_statistics_events.php");
?>