...
$smarty->display("Copy_of_calendar_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=Copy_of_calendar.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=Copy_of_calendar.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=Copy_of_calendar.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=Copy_of_calendar.csv");
