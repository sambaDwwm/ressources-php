...
$smarty->display("customer_statistics_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=customer_statistics.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=customer_statistics.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=customer_statistics.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=customer_statistics.csv");
