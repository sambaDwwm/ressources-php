...
$smarty->display("edit_calendar_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=edit_calendar.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=edit_calendar.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=edit_calendar.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=edit_calendar.csv");
