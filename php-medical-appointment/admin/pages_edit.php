...
if($objLogin->IsLoggedInAsAdmin() && $objLogin->HasPrivileges('edit_pages')){
    ...
    // draw title bar
    draw_title_bar(
        prepare_breadcrumbs(array(_MENUS_AND_PAGES=>'',_PAGE_MANAGEMENT=>'',((Application::Get('page_id') != 'home')?_EDIT_PAGE:_PAGE_EDIT_HOME)=>'')),
        ((Application::Get('page_id') != "home") ? '<a target="_preview_page" href="index.php?page=pages&pid='.$objPage->GetParameter('id').'&preview=yes&preview_type=single">'._PREVIEW.'</a> <img src="images/external_link.gif" alt="external link">' : '')
    );
			...
			<td valign="top" style="border:1px solid #dedede">
				...
				<tr>
					<td>
						...
						<img class="help" src="images/question_mark.png" alt="help" title="URL: index.php?page=pages&system_page=<?php echo $objPage->GetParameter('system_page');?>" />					
					</td>
					<td>
				...
				<tr id="link_row_1" style="display:none;">
					<td><?php echo _LINK;?> <span class="required">*</span>:</td>
					<td>
                        <input class="form_text" name="link_url" id="frmPage_link_url" value="<?php echo $objPage->GetParameter('link_url');?>" size="50" maxlength="255" /><br>
                        <span class="gray">(e.g. http://www.domain.com/index.html or index.php?page=inner_page)</span>
                    </td>
				</tr>
			...
			<td valign="top" style="width:270px;border:1px solid #dedede">
				...
				<?php if(Application::Get('page_id') != 'home'){ ?>	
					...
					<tr>
						...
						<td colspan="2"><?php echo format_datetime($objPage->GetParameter('date_created'), '', '', true); ?></td>
					</tr>
					<?php } ?>
				<?php } ?>				
					<tr>
						<td><?php echo _DATE_MODIFIED;?>:</td>
						<td colspan="2"><?php echo format_datetime($objPage->GetParameter('date_updated'), '', _NEVER, true); ?></td>
					</tr>
				<?php if(Application::Get('page_id') != 'home' && Application::Get('type') != 'system'){ ?>
                    <tr>
                        ...
                        <td colspan="2">
							...
							<img id='finish_publishing_icon' class='calendar_icon' src='images/cal.gif' alt='calendar' />
                        </td>
                    </tr>
				<?php } ?>								
