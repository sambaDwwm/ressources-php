...
if($objLogin->IsLoggedInAsAdmin()){
	...
	$predefined_tags_text = '
		...
		<ul>
			...
			<li>{APPOINTMENT NUMBER} - <span class=gray>'._PC_APPOINTMENT_NUMBER_TEXT.'</span></li>
			<li>{APPOINTMENT DETAILS} - <span class=gray>'._PC_APPOINTMENT_DETAILS_TEXT.'</span></li>
			<li>{HOURS} - <span class=gray>'._PC_HOURS_TEXT.'</span></li>
			<li>{ACCOUNT TYPE} - <span class=gray>'._PC_ACCOUNT_TYPE_TEXT.'</span></li>
