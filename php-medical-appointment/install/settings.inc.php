...
*/
    ...
    define('EI_PASSWORD_ENCRYPTION_KEY', 'apphp_medical_appointment');    
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'ApPHP Medical Appointment');
